            ...
            <div class="nav-wrapper teal lighten-2">
                ...
                <form action='customer' method='POST'>
                    <ul class="button hide-on-med-and-down">
                        ...
                        <li class='nav'><button class='waves-effect waves-light btn-large' type='submit' name="action" value='logout'><i class="material-icons">account_circle</i></button></li>
                    </ul>
                </form>
            </div>
        </nav>
            ...
            <div class="search nav-wrapper teal lighten-2">
                <form action='customer' method='POST'>
                    <div class="input-field">
                        <input id="search" type="hidden" name='action' value='mainpage'>
